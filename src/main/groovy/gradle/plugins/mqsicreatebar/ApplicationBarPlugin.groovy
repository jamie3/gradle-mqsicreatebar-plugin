 ...
 *
 */
class ApplicationBarPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
		...
		// add task classes
		project.task('createApplicationBar', type: CreateApplicationBarTask, dependsOn: 'init')
		project.task('applyBarOverride', type: ApplyBarOverrideTask, dependsOn: 'createApplicationBar')
